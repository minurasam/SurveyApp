...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.mergeBuffer = function (buffer) {
    ...
    Parser.prototype.parseReadyForQueryMessage = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
        var status = this.reader.string(1);
        return new messages_1.ReadyForQueryMessage(length, status);
    };
    Parser.prototype.parseCommandCompleteMessage = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
        var text = this.reader.cstring();
        return new messages_1.CommandCompleteMessage(length, text);
    };
    Parser.prototype.parseCopyData = function (offset, length, bytes) {
        var chunk = bytes.slice(offset, offset + (length - 4));
        return new messages_1.CopyDataMessage(length, chunk);
    };
    Parser.prototype.parseCopyInMessage = function (offset, length, bytes) {
        return this.parseCopyMessage(offset, length, bytes, 'copyInResponse');
    };
    Parser.prototype.parseCopyOutMessage = function (offset, length, bytes) {
        return this.parseCopyMessage(offset, length, bytes, 'copyOutResponse');
    };
    Parser.prototype.parseCopyMessage = function (offset, length, bytes, messageName) {
        this.reader.setBuffer(offset, bytes);
    ...
    Parser.prototype.parseNotificationMessage = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
    ...
    Parser.prototype.parseRowDescriptionMessage = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
    ...
    Parser.prototype.parseParameterDescriptionMessage = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
    ...
    Parser.prototype.parseDataRowMessage = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
        var fieldCount = this.reader.int16();
    ...
    Parser.prototype.parseParameterStatusMessage = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
        var name = this.reader.cstring();
        var value = this.reader.cstring();
        return new messages_1.ParameterStatusMessage(length, name, value);
    };
    Parser.prototype.parseBackendKeyData = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
        var processID = this.reader.int32();
        var secretKey = this.reader.int32();
        return new messages_1.BackendKeyDataMessage(length, processID, secretKey);
    };
    Parser.prototype.parseAuthenticationResponse = function (offset, length, bytes) {
        this.reader.setBuffer(offset, bytes);
    ...
    Parser.prototype.parseErrorMessage = function (offset, length, bytes, name) {
        this.reader.setBuffer(offset, bytes);
        var fields = {};
