...
var test_buffers_1 = require("./testing/test-buffers");
var buffer_list_1 = require("./testing/buffer-list");
var _1 = require(".");
...
var testForMessage = function (buffer, expectedMessage) {
    var _this = this;
    it('recieves and parses ' + expectedMessage.name, function () { return __awaiter(_this, void 0, void 0, function () {
        var messages, lastMessage, key;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, parseBuffers([buffer])];
                case 1:
                    messages = _a.sent();
...
var parseBuffers = function (buffers) { return __awaiter(void 0, void 0, Promise, function () {
    var stream, _i, buffers_1, buffer, msgs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                stream.end();
                msgs = [];
                return [4 /*yield*/, _1.parse(stream, function (msg) { return msgs.push(msg); })];
            case 1:
                _a.sent();
    ...
    describe('split buffer, single message parsing', function () {
        ...
        it('parses when full buffer comes in', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, parseBuffers([fullBuffer])];
                        case 1:
                            messages = _a.sent();
                            message = messages[0];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, parseBuffers([fullBuffer])];
                        case 1:
                            messages = _a.sent();
                            message = messages[0];
                            assert_1["default"].equal(message.fields.length, 5);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            fullBuffer.copy(firstBuffer, 0, 0);
                            fullBuffer.copy(secondBuffer, 0, firstBuffer.length);
                            return [4 /*yield*/, parseBuffers([firstBuffer, secondBuffer])];
                        case 1:
                            messages = _a.sent();
                            verifyMessages(messages);
                            return [2 /*return*/];
