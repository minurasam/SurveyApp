  ...
  case 'v5':
    {
      ...
      var _namespace = args.shift();

      (0, _assert["default"])(_name != null, 'v5 name not specified');
      (0, _assert["default"])(_namespace != null, 'v5 namespace not specified');

      if (_namespace === 'URL') {
        _namespace = _v4["default"].URL;
      }

      if (_namespace === 'DNS') {
        _namespace = _v4["default"].DNS;
      }

      console.log((0, _v4["default"])(_name, _namespace));
      break;
    }
