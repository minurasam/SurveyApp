      ...
      a = this, function (e) {
        ...
        var ae = {
          ...
          serialize: function serialize(e, r) {
            ...
            for (d in h) {
              h[d] !== M[d] && p.push(d.replace(W, te).replace(W, f).replace(ee, m) + "=" + h[d].replace(W, te).replace(W, f).replace(re, m));
            }
