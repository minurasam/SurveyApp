...
var conditionallyMergeWriteConcern = require('./utils').conditionallyMergeWriteConcern;
...
var COLLECTION_OPTION_KEYS = ['pkFactory', 'readPreference', 'serializeFunctions', 'strict', 'readConcern', 'ignoreUndefined', 'promoteValues', 'promoteBuffers', 'promoteLongs'];
/**
...
Db.prototype.collection = function (name, options, callback) {
  ...
  try {
    for (var _iterator = COLLECTION_OPTION_KEYS[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var collectionOptionKey = _step.value;
