...
module.exports = {
  ...
  resolveClusterTime: resolveClusterTime,
  inquireServerState: inquireServerState,
  getTopologyType: getTopologyType,
  emitServerDescriptionChanged: emitServerDescriptionChanged,
  emitTopologyDescriptionChanged: emitTopologyDescriptionChanged,
  cloneOptions: cloneOptions,
  createCompressionInfo: createCompressionInfo,
  clone: clone,
  diff: diff,
  Interval: Interval,
  Timeout: Timeout,
  isRetryableWritesSupported: isRetryableWritesSupported,
  getMMAPError: getMMAPError,
  topologyType: topologyType,
  legacyIsRetryableWriteError: legacyIsRetryableWriteError
};