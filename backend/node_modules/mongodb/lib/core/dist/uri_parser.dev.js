...
var HOSTS_RX = /(mongodb(?:\+srv|)):\/\/(?: (?:[^:]*) (?: : ([^@]*) )? @ )?([^/?]*)(?:\/|)(.*)/; // Options that reference file paths should not be parsed

var FILE_PATH_OPTIONS = new Set(['sslCA', 'sslCert', 'sslKey', 'tlsCAFile', 'tlsCertificateKeyFile'].map(function (key) {
...
function parseQueryString(query, options) {
  ...
  for (var key in parsedQueryString) {
    ...
    var parsedValue = FILE_PATH_OPTIONS.has(normalizedKey) ? value : parseQueryStringItemValue(normalizedKey, value);
