...
var _normalize = function _normalize(name) {
...
var _getStorageId = function _getStorageId(client) {
...
var _loadCookies = function _loadCookies(client) {
...
var _saveCookies = function _saveCookies(client) {
  if (client.persistCookies) {
    try {
...
var _clearCookies = function _clearCookies(client) {
  if (client.persistCookies) {
    try {
...
var _doRequest = function _doRequest(client, socket) {
...
var _handleNextRequest = function _handleNextRequest(client, socket) {
  // clear buffer
...
var _initSocket = function _initSocket(client, socket, tlsOptions) {
...
var _hasCookieExpired = function _hasCookieExpired(cookie) {
  var rval = false;
...
var _writeCookies = function _writeCookies(client, request) {
  var expired = [];
  var url = client.url;
...
var _readCookies = function _readCookies(client, response) {
...
http.createClient = function (options) {
  ...
  var _defaultCertificateVerify = function _defaultCertificateVerify(c, verified, depth, certs) {
...
var _trimString = function _trimString(str) {
...
var _createHeader = function _createHeader() {
  var header = {
    ...
    appendField: function appendField(name, value) {
    ...
    getField: function getField(name, index) {
      var rval = null;
      name = _normalize(name);
...
var _getUtcTime = function _getUtcTime(d) {
...
http.createResponse = function () {
  ...
  var _readCrlf = function _readCrlf(b) {
    var line = null;
  ...
  var _parseHeader = function _parseHeader(line) {
  ...
  var _readChunkedBody = function _readChunkedBody(b) {
