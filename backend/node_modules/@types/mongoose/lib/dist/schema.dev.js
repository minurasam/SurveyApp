...
Schema.prototype.path = function (path, obj) {
  ...
  if (schemaType.$isSingleNested) {
    ...
    for (var _i3 = 0, _Object$keys2 = Object.keys(schemaType.schema.singleNestedPaths); _i3 < _Object$keys2.length; _i3++) {
      var _key = _Object$keys2[_i3];
      this.singleNestedPaths[path + '.' + _key] = schemaType.schema.singleNestedPaths[_key];
    }

    for (var _i4 = 0, _Object$keys3 = Object.keys(schemaType.schema.subpaths); _i4 < _Object$keys3.length; _i4++) {
      var _key2 = _Object$keys3[_i4];
      this.singleNestedPaths[path + '.' + _key2] = schemaType.schema.subpaths[_key2];
    }

    for (var _i5 = 0, _Object$keys4 = Object.keys(schemaType.schema.nested); _i5 < _Object$keys4.length; _i5++) {
  ...
  if (schemaType.$isMongooseArray && schemaType.caster instanceof SchemaType) {
    ...
    for (var _i6 = 0, _toAdd = toAdd; _i6 < _toAdd.length; _i6++) {
      var _schemaType2 = _toAdd[_i6];
      this.subpaths[_schemaType2.path] = _schemaType2;
    }
  }

  if (schemaType.$isMongooseDocumentArray) {
    for (var _i7 = 0, _Object$keys5 = Object.keys(schemaType.schema.paths); _i7 < _Object$keys5.length; _i7++) {
      var _key4 = _Object$keys5[_i7];
      this.subpaths[path + '.' + _key4] = schemaType.schema.paths[_key4];
      schemaType.schema.paths[_key4].$isUnderneathDocArray = true;
    }

    for (var _i8 = 0, _Object$keys6 = Object.keys(schemaType.schema.subpaths); _i8 < _Object$keys6.length; _i8++) {
      var _key5 = _Object$keys6[_i8];
      this.subpaths[path + '.' + _key5] = schemaType.schema.subpaths[_key5];
      schemaType.schema.subpaths[_key5].$isUnderneathDocArray = true;
    }

    for (var _i9 = 0, _Object$keys7 = Object.keys(schemaType.schema.singleNestedPaths); _i9 < _Object$keys7.length; _i9++) {
      var _key6 = _Object$keys7[_i9];
...
function gatherChildSchemas(schema) {
  ...
  for (var _i10 = 0, _Object$keys8 = Object.keys(schema.paths); _i10 < _Object$keys8.length; _i10++) {
    var path = _Object$keys8[_i10];
...
function getMapPath(schema, path) {
  for (var _i11 = 0, _Object$keys9 = Object.keys(schema.paths); _i11 < _Object$keys9.length; _i11++) {
    var _path = _Object$keys9[_i11];
