...
function (_MongooseError) {
  ...
  function VersionError(doc, currentVersion, modifiedPaths) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(VersionError).call(this, 'No matching document found for id "' + doc._id + '" version ' + currentVersion + ' modifiedPaths "' + modifiedPathsStr + '"'));
