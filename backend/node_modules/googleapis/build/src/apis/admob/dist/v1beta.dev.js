...
(function (admob_v1beta) {
   ...
   * ```
   */
  var Admob = function Admob(options, google) {
  ...
  function () {
    ...
    _createClass(Resource$Accounts, [{
      ...
      value: function get(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://admob.googleapis.com/';
        var parameters = {
  ...
  var Resource$Accounts$Apps =
  /*#__PURE__*/
  function () {
    function Resource$Accounts$Apps(context) {
      _classCallCheck(this, Resource$Accounts$Apps);

      this.context = context;
    }

    _createClass(Resource$Accounts$Apps, [{
      key: "list",
      value: function list(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
    ...
    return Resource$Accounts$Apps;
  }();

  admob_v1beta.Resource$Accounts$Apps = Resource$Accounts$Apps;

  var Resource$Accounts$Mediationreport =
  /*#__PURE__*/
  function () {
    function Resource$Accounts$Mediationreport(context) {
      _classCallCheck(this, Resource$Accounts$Mediationreport);

      this.context = context;
    }

    _createClass(Resource$Accounts$Mediationreport, [{
      key: "generate",
    ...
    return Resource$Accounts$Mediationreport;
  }();

  admob_v1beta.Resource$Accounts$Mediationreport = Resource$Accounts$Mediationreport;

  var Resource$Accounts$Networkreport =
  /*#__PURE__*/
  function () {
    function Resource$Accounts$Networkreport(context) {
      _classCallCheck(this, Resource$Accounts$Networkreport);

      this.context = context;
    }

    _createClass(Resource$Accounts$Networkreport, [{
      key: "generate",
      value: function generate(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
    ...
    return Resource$Accounts$Networkreport;
  }();
