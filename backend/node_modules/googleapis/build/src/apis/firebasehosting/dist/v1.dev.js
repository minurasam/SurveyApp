...
(function (firebasehosting_v1) {
   ...
   * ```
   */
  var Firebasehosting = function Firebasehosting(options, google) {
    _classCallCheck(this, Firebasehosting);
  ...
  function () {
    ...
    _createClass(Resource$Operations, [{
      ...
      value: function cancel(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://firebasehosting.googleapis.com/';
        var parameters = {
