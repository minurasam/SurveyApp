...
(function (firebasedatabase_v1beta) {
   ...
   * ```
   */
  var Firebasedatabase = function Firebasedatabase(options, google) {
  ...
  function () {
    ...
    _createClass(Resource$Projects$Locations$Instances, [{
      ...
      value: function create(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://firebasedatabase.googleapis.com/';
        var parameters = {
      ...
      key: "reenable",
      value: function reenable(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
