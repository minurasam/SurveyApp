...
(function (cloudscheduler_v1beta1) {
   ...
   * ```
   */
  var Cloudscheduler = function Cloudscheduler(options, google) {
    _classCallCheck(this, Cloudscheduler);
  ...
  function () {
    ...
    _createClass(Resource$Projects$Locations, [{
      ...
      value: function get(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://cloudscheduler.googleapis.com/';
        var parameters = {
