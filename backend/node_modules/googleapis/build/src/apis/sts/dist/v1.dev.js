...
(function (sts_v1) {
   ...
   * ```
   */
  var Sts = function Sts(options, google) {
  ...
  function () {
    ...
    _createClass(Resource$V1, [{
      key: "token",
      value: function token(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://sts.googleapis.com/';
        var parameters = {
