...
(function (artifactregistry_v1) {
  ...
  var Resource$Projects$Locations$Repositories = function Resource$Projects$Locations$Repositories(context) {
  ...
  var Resource$Projects$Locations$Repositories$Dockerimages =
  /*#__PURE__*/
  function () {
    function Resource$Projects$Locations$Repositories$Dockerimages(context) {
      _classCallCheck(this, Resource$Projects$Locations$Repositories$Dockerimages);

      this.context = context;
    }

    _createClass(Resource$Projects$Locations$Repositories$Dockerimages, [{
      key: "list",
      value: function list(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
    ...
    return Resource$Projects$Locations$Repositories$Dockerimages;
  }();
