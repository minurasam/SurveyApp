...
(function (workflowexecutions_v1beta) {
   ...
   * ```
   */
  var Workflowexecutions = function Workflowexecutions(options, google) {
    _classCallCheck(this, Workflowexecutions);
  ...
  var Resource$Projects$Locations$Workflows = function Resource$Projects$Locations$Workflows(context) {
    _classCallCheck(this, Resource$Projects$Locations$Workflows);
  ...
  var Resource$Projects$Locations$Workflows$Executions =
  /*#__PURE__*/
  function () {
    function Resource$Projects$Locations$Workflows$Executions(context) {
      _classCallCheck(this, Resource$Projects$Locations$Workflows$Executions);

      this.context = context;
    }

    _createClass(Resource$Projects$Locations$Workflows$Executions, [{
      key: "cancel",
      value: function cancel(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://workflowexecutions.googleapis.com/';
        var parameters = {
    ...
    return Resource$Projects$Locations$Workflows$Executions;
  }();
