...
(function (firebaseml_v1beta2) {
   ...
   * ```
   */
  var Firebaseml = function Firebaseml(options, google) {
    _classCallCheck(this, Firebaseml);
  ...
  var Resource$Projects$Models =
  /*#__PURE__*/
  function () {
    function Resource$Projects$Models(context) {
      _classCallCheck(this, Resource$Projects$Models);

      this.context = context;
    }

    _createClass(Resource$Projects$Models, [{
      key: "create",
      value: function create(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://firebaseml.googleapis.com/';
        var parameters = {
