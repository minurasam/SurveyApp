...
(function (discovery_v1) {
   ...
   * ```
   */
  var Discovery = function Discovery(options, google) {
  ...
  /*#__PURE__*/
  function () {
    function Resource$Apis(context) {
      _classCallCheck(this, Resource$Apis);

      this.context = context;
    }

    _createClass(Resource$Apis, [{
      key: "getRest",
      value: function getRest(paramsOrCallback, optionsOrCallback, callback) {
