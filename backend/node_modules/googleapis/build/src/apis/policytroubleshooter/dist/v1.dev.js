...
(function (policytroubleshooter_v1) {
   ...
   * ```
   */
  var Policytroubleshooter = function Policytroubleshooter(options, google) {
    _classCallCheck(this, Policytroubleshooter);
  ...
  /*#__PURE__*/
  function () {
    function Resource$Iam(context) {
      _classCallCheck(this, Resource$Iam);

      this.context = context;
    }

    _createClass(Resource$Iam, [{
      key: "troubleshoot",
      value: function troubleshoot(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://policytroubleshooter.googleapis.com/';
        var parameters = {
