...
(function (sourcerepo_v1) {
   ...
   * ```
   */
  var Sourcerepo = function Sourcerepo(options, google) {
    _classCallCheck(this, Sourcerepo);
  ...
  function () {
    ...
    _createClass(Resource$Projects, [{
      ...
      key: "updateConfig",
      value: function updateConfig(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
  ...
  var Resource$Projects$Repos =
  /*#__PURE__*/
  function () {
    function Resource$Projects$Repos(context) {
      _classCallCheck(this, Resource$Projects$Repos);

      this.context = context;
    }

    _createClass(Resource$Projects$Repos, [{
      key: "create",
