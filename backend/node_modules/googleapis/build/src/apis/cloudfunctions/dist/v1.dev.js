...
(function (cloudfunctions_v1) {
   ...
   * ```
   */
  var Cloudfunctions = function Cloudfunctions(options, google) {
    _classCallCheck(this, Cloudfunctions);
  ...
  var Resource$Projects$Locations$Functions =
  /*#__PURE__*/
  function () {
    function Resource$Projects$Locations$Functions(context) {
      _classCallCheck(this, Resource$Projects$Locations$Functions);

      this.context = context;
    }

    _createClass(Resource$Projects$Locations$Functions, [{
      key: "call",
      value: function call(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
      ...
      value: function generateDownloadUrl(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
      ...
      value: function generateUploadUrl(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
