...
(function (lifesciences_v2beta) {
   ...
   * ```
   */
  var Lifesciences = function Lifesciences(options, google) {
    _classCallCheck(this, Lifesciences);
  ...
  function () {
    ...
    _createClass(Resource$Projects$Locations, [{
      ...
      value: function get(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://lifesciences.googleapis.com/';
        var parameters = {
  ...
  var Resource$Projects$Locations$Pipelines =
  /*#__PURE__*/
  function () {
    function Resource$Projects$Locations$Pipelines(context) {
      _classCallCheck(this, Resource$Projects$Locations$Pipelines);

      this.context = context;
    }

    _createClass(Resource$Projects$Locations$Pipelines, [{
      key: "run",
    ...
    return Resource$Projects$Locations$Pipelines;
  }();
