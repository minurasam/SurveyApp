...
(function (redis_v1) {
   ...
   * ```
   */
  var Redis = function Redis(options, google) {
  ...
  function () {
    ...
    _createClass(Resource$Projects$Locations, [{
      ...
      value: function get(paramsOrCallback, optionsOrCallback, callback) {
        ...
        var rootUrl = options.rootUrl || 'https://redis.googleapis.com/';
        var parameters = {
  ...
  function () {
    ...
    _createClass(Resource$Projects$Locations$Instances, [{
      ...
      key: "getAuthString",
      value: function getAuthString(paramsOrCallback, optionsOrCallback, callback) {
        var params = paramsOrCallback || {};
        var options = optionsOrCallback || {};
