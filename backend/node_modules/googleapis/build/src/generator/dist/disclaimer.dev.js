...
exports.libraryListUrl = 'https://raw.githubusercontent.com/googleapis/google-cloud-node/master/libraries.json'; // exported for mocking purposes
      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(gaxios_1.request({
            url: exports.libraryListUrl
          }));

        case 2:
          res = _context.sent;
          disclaimers = res.data.map(function (lib) {
            return {
