...
function (_InnerState) {
  _inherits(TransactionMode, _InnerState);

  function TransactionMode(options) {
    _classCallCheck(this, TransactionMode);

    options = assertOptions(options, ["tiLevel", "deferrable", "readOnly"]);
    var _options = options,
        readOnly = _options.readOnly,
        deferrable = _options.deferrable;
    var _options2 = options,
        tiLevel = _options2.tiLevel;
    var level,
        accessMode,
        deferrableMode,
        begin = "begin";
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TransactionMode).call(this, {
      begin: begin,
  ...
  _createClass(TransactionMode, [{
    key: "begin",
    value: function begin(cap) {
