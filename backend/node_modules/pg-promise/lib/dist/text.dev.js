...
var streamVersion = require("../package.json").devDependencies["pg-query-stream"];
...
module.exports = {
  ...
  invalidStream: "Invalid or missing stream object: pg-query-stream >= v".concat(streamVersion, " was expected"),
