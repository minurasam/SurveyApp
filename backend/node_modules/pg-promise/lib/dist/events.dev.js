...
function () {
  ...
  _createClass(Events, null, [{
     ...
     * };
     */
    value: function connect(ctx, client, useCount) {
    ...
    key: "disconnect",
    value: function disconnect(ctx, client) {
    ...
    key: "query",
    value: function query(options, context) {
    ...
    key: "receive",
    value: function receive(options, data, result, context) {
    ...
    key: "task",
    value: function task(options, context) {
    ...
    key: "transact",
    value: function transact(options, context) {
    ...
    key: "error",
    value: function error(options, err, context) {
    ...
    key: "extend",
    value: function extend(options, obj, dc) {
    ...
    key: "unexpected",
    value: function unexpected(event, e) {
      ...
      if (!npm.main.suppressErrors) {
        ...
        ColorConsole.error("Unexpected error in '".concat(event, "' event handler.\n").concat(stack, "\n"));
      }
    }
  }]);
