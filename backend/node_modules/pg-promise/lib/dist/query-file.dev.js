...
var _require2 = require("./errors"),
    QueryFileError = _require2.QueryFileError;

var _require3 = require("assert-options"),
    assertOptions = _require3.assertOptions;

var _require4 = require("./utils/color"),
    ColorConsole = _require4.ColorConsole;
...
function (_InnerState) {
  _inherits(QueryFile, _InnerState);

  function QueryFile(file, options) {
    var _this;

    _classCallCheck(this, QueryFile);
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(QueryFile).call(this, _inner));
  ...
  _createClass(QueryFile, [{
     ...
     */
    value: function prepare(throwErrors) {
      var _i = this._inner,
          options = _i.options;
      var lastMod;
    ...
    key: "instance",
    get: function get() {
      var s = Symbol["for"]("pgPromiseQueryFile");
      var scope = global[s];
  ...
  return QueryFile;
}(InnerState); // Hiding the query as a symbol within the type,
