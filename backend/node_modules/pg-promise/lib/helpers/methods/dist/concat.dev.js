 ...
 */
var _require = require("../../query-file"),
    QueryFile = _require.QueryFile;
...
function concat(queries, capSQL) {
  ...
  var all = queries.map(function (q, index) {
    if (typeof q === "string") {
