...
var _require2 = require("../table-name"),
    TableName = _require2.TableName;

var _require3 = require("../column-set"),
    ColumnSet = _require3.ColumnSet;
  ...
  if (isArray) {
    ...
    var values = data.map(function (d, index) {
      if (!d || typeof d !== "object") {
        throw new Error("Invalid update object at index ".concat(index, "."));
      }
