 ...
 */
var _require = require("./column"),
    Column = _require.Column;

var _require2 = require("./column-set"),
    ColumnSet = _require2.ColumnSet;
...
module.exports = function (config) {
  var capSQL = function capSQL() {
    return config.options && config.options.capSQL;
  };
  ...
  var res = {
    ...
    concat: function concat(queries) {
      return method.concat(queries, capSQL());
    },
    values: function values(data, columns) {
      return method.values(data, columns, capSQL());
    },
    sets: function sets(data, columns) {
