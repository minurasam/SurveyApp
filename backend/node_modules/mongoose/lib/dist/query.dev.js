...
Query.prototype.select = function select() {
  ...
  if (utils.isObject(arg)) {
    ...
    for (var i = 0; i < keys.length; ++i) {
      var value = arg[keys[i]]; // Workaround for gh-10142
...
Query.prototype._castUpdate = function _castUpdate(obj, overwrite) {
  ...
  if (schema != null && utils.hasUserDefinedProperty(filter, schema.options.discriminatorKey) && _typeof(filter[schema.options.discriminatorKey]) !== 'object' && schema.discriminators != null) {
    ...
    var byValue = getDiscriminatorByValue(this.model.discriminators, discriminatorValue);
...
Query.prototype.tailable = function (val, opts) {
  ...
  if (opts && _typeof(opts) === 'object') {
    for (var _i4 = 0, _Object$keys2 = Object.keys(opts); _i4 < _Object$keys2.length; _i4++) {
