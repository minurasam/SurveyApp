...
function (_MongooseError) {
  ...
  function ObjectExpectedError(path, val) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ObjectExpectedError).call(this, 'Tried to set nested object field `' + path + "` to ".concat(typeDescription, " `") + val + '` and strict mode is set to throw.'));
    _this.path = path;
    return _this;
  }
