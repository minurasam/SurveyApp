...
assert.equalBuffers = function (actual, expected) {
  var spit = function spit(actual, expected) {
    console.log("");
...
suite('adding int32', function () {
  var testAddingInt32 = function testAddingInt32(_int, expectedBuffer) {
    test('writes ' + _int, function () {
      var subject = new Writer();
      var result = subject.addInt32(_int).join();
