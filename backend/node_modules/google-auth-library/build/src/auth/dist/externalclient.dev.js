...
var identitypoolclient_1 = require("./identitypoolclient");
...
var ExternalAccountClient =
/*#__PURE__*/
function () {
  function ExternalAccountClient() {
    _classCallCheck(this, ExternalAccountClient);
  ...
  _createClass(ExternalAccountClient, null, [{
    key: "fromJSON",
    value: function fromJSON(options, additionalOptions) {
      var _a;
